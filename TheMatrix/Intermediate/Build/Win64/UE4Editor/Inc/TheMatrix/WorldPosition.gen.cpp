...
#include "TheMatrix/WorldPosition.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	THEMATRIX_API UClass* Z_Construct_UClass_UWorldPosition_NoRegister();
	THEMATRIX_API UClass* Z_Construct_UClass_UWorldPosition();
	ENGINE_API UClass* Z_Construct_UClass_UActorComponent();
	UPackage* Z_Construct_UPackage__Script_TheMatrix();
// End Cross Module References
	...
	UObject* (*const Z_Construct_UClass_UWorldPosition_Statics::DependentSingletons[])() = {
		...
		(UObject* (*)())Z_Construct_UPackage__Script_TheMatrix,
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UWorldPosition, 2007314566);
	template<> THEMATRIX_API UClass* StaticClass<UWorldPosition>()
	{
		return UWorldPosition::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UWorldPosition(Z_Construct_UClass_UWorldPosition, &UWorldPosition::StaticClass, TEXT("/Script/TheMatrix"), TEXT("UWorldPosition"), false, nullptr, nullptr, nullptr);
